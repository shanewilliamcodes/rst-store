...
export const products: Product[] = [
  {
    ...
    audience: ["Mom"],
    description: "A heavyweight, garment-dyed tee with soft drape and real structure, finished with the RST monogram embroidered tone-on-tone on the chest.",
    details: [
      "RST monogram embroidered on the left chest",
      "Tonal stitching — subtle, wears with anything",
    ...
    detailType: "heart",
    signatureDetail: "The RST monogram, embroidered tone-on-tone on the chest.",
    hasSleeveMark: false,
    accent: "#5f5e5a",
  },
  {
    ...
    audience: ["Dad"],
    description: "A substantial, garment-dyed tee that keeps its collar and its shape, finished with the RST monogram embroidered tone-on-tone on the chest.",
    details: [
      "RST monogram embroidered on the left chest",
      "Tonal stitching — subtle, wears with anything",
      "Garment-dyed 6.1 oz ring-spun cotton (Comfort Colors 1717)",
  ...
  },
  {
    ...
    audience: ["Baby"],
    description: "An exceptionally soft first tee with the RST monogram embroidered tone-on-tone on the chest.",
    details: [
      "RST monogram embroidered on the chest",
  ...
  },
  {
    ...
    description: "Play-ready, garment-dyed softness with the RST monogram embroidered tone-on-tone on the chest.",
    details: [
      "RST monogram embroidered on the chest",
...
export const collections = [
  { slug: "mom", name: "Mom", description: "The Mom Tee, with the RST monogram on the chest.", image: "/mockups/the-mom-tee/cream.jpg" },
  { slug: "dad", name: "Dad", description: "The Dad Tee, with the RST monogram on the chest.", image: "/mockups/the-dad-tee/washed-black.jpg" },
  { slug: "baby", name: "Baby", description: "The Baby Tee, with the RST monogram on the chest.", image: "/mockups/the-baby-tee/cream.jpg" },
  { slug: "little", name: "Little", description: "The Little Tee, with the RST monogram on the chest.", image: "/mockups/the-little-tee/cream.jpg" },
];
